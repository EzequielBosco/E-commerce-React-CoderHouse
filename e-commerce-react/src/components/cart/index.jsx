...
const Cart = () => {
    ...
    return(
        <div className="container">
            ...
            <h1 className="title text-center m-2">Carrito</h1>
            ...
            <>
                ...
                <div className="cart-container">
                    {cart.map((p) => (
                        <div key={p.id} className="cart">
                            ...
                            <Button onClick={() => decrease(p.id)} className="btn-quantity">-</Button>
                            <h5>({p.quantity})</h5>
                            <Button onClick={() => increase(p.id)} className="btn-quantity">+</Button>
                            </div>
                            </div>
                            <Button onClick={() => removeProduct(p.id)} className="btn-delete">                            
                ...
                <div className="d-flex gap-3 justify-content-around align-items-center">
                    ...
                    {/* <Button onClick={() => purchaseCart()} className="button-color">
                            Finalizar compra
                    </Button> */}
            ...
            <div className="d-flex flex-column align-items-center">
                <h3 className="text-center m-3">El carrito se encuentra vacío</h3>
